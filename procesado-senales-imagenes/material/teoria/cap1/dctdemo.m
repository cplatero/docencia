...
%
% DCTDEMO is a deprecated demo and may be removed in a future version.
...
%   $Revision: 1.17.4.5 $  $Date: 2005/06/20 03:06:47 $
...
errorImage = (trueImage - newImage).^2;
MSE = sum(errorImage(:))/prod(size(trueImage));
