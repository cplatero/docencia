...
%   $Revision: 1.18 $  $Date: 2001/01/18 16:02:52 $
...
ud.hImgPop = uicontrol(Ctl, ...
   ...
   'Enable','on', ...
   'String','Circuit|Tire|Flower|Rice|Pout|Trees|Saturn|Quarter|Bone Marrow|Aluminum', ...
   'Tag','ImagesPop',...
...
case 1   % Intensity Adjustment
   ...
   set(get(ud.hAdjustToolAxes, 'Title'), 'String', 'Intensity Transformation');
