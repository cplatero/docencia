...
runThis('E9_Hands_MLIRmb','MLIR, hands, elastic, matrix based');
runThis('E9_Hands_MLIRmf','MLIR, hands, elastic, matrix free');

runThis('E9_Hands_MLIR_mbCurv','MLIR, hands, curvature, matrix based');
runThis('E9_Hands_MLIR_mfCurv','MLIR, hands, curvature, matrix free');
...
runThis('E9_HNSP_MLIR_mbCurv','MLIR, HNSP, curvature, matrix based');
runThis('E9_HNSP_MLIR_mfCurv','MLIR, HNSP, curvature, matrix free');
