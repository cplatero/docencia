function runfsl_flirt_test()

pathImgFiles='/home/Compartida/Img/hipocampo/Test/Brains/';
% pathLabelFiles='/home/Compartida/Img/hipocampo/Test/Labels/';
% pathResulImg='/home/Compartida/Img/hipocampo/Train/ref01/';
pathResulImg='/home/Compartida/Img/hipocampo/Test/ref21/';
...
for i=1:numel(listImgFiles)
    if(strcmp(listImgFiles(i).name,'HFH_021_brain.hdr')==0)
%     if(i ~= numRef)
%    if(i == numRef)    
