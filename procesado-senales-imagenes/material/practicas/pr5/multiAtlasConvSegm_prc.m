function multiAtlasConvSegm_prc()
warning('off');
ROI = 1;
numFusedAtlases = 15;
%% Atlases
% load('ROIs_ref21Ori');
load('D:/compartido/Img/hipocampo/Registros/afin/ROIs_IBSROri');
%load('D:/compartido/Img/hipocampo/Registros/afin/ROIs_ref21Ori');
...
% Spacing=[0.39;2;0.39]; (HFH)
Spacing=[0.9375;1.5;0.9375]; %IBSR
